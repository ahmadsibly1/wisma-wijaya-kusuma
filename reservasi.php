                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select" name="tipe" aria-label="Default select example" required>
                                                    ...
                                                    <option value="regular">101</option>
                                                    <option value="vip">107</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select" name="layanan" aria-label="Default select example" required>
                                                    <option selected>Pilih nomor kamar</option>
                                                    <option value="regular">Extra bed</option>
                                                    <option value="vip">Small bed</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="biaya" class="form-control" id="biaya" placeholder="*" required>
                                            </div>
                                        </div>
